...
def main():
    ...
    parser.add_argument('--seg_model_path', default='./DocScanner/model_pretrained/seg.pth')
    parser.add_argument('--rec_model_path', default='./DocScanner/model_pretrained/DocScanner-L.pth')
    parser.add_argument('--distorrted_path', default='./DocScanner/distorted/')
    parser.add_argument('--rectified_path', default='./DocScanner/rectified/')
